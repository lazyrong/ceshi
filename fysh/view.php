...
if ($score > 20 && $score <= 40) {
	...
	$jieguo = "你的上海话貌似还欠点火候，在学习学习吧～";
}

if ($score > 40 && $score <= 60) {
	// $jieguo="到上海有几年了吧～有些上海味喽～魔都魔都魔都都～";
	$jieguo = "到上海有几年了吧～有些上海味喽～哈哈哈～";
}
...
$content = '我刚在《疯狂方言测试》参加了上海话八级水平考试并取得了' . $score . '的成绩，得到评价：' . $jieguo . ' 会讲英语算神马~会讲韩语是浮云~会讲日语鄙视你！有本事讲讲上海话！点击测试为普及上海话献出一份力量！ 测试地址：' . $url;
