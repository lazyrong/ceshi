...
function on_submit()
{
	if(document.getElementById('my_qq0').value=='')
	{
		alert('请填写您的名字！');
		document.getElementById('my_qq0').focus();
		return false;
	}
...
<body  class="ui-overlay-c" style="cursor: auto; zoom: 1;">
	...
	<div data-role="content" >
		...
		?>
			...
			<form action="/3/<?=$app_name?>/" method="post" id="form1" name="form1" >
			<div data-role="controlgroup" >
	            <label for="my_qq0">
	                你的名字：
	            </label>
	            <input name="my_qq0" id="my_qq0"   placeholder="你的名字" value="" type="text">
	        </div>
			<div data-role="controlgroup" >
	            <label for="my_qq1">
	                你QQ的第一位数：
	            </label>
	            <input name="my_qq1" id="my_qq1" maxlength="1" size="1"  placeholder="你QQ的第一位数" value="" type="number">
	        </div>
			<div data-role="controlgroup" >
	            <label for="my_qq2">
	               你QQ的第五位数：
	            </label>
	            <input name="my_qq2" id="my_qq2" maxlength="1"  size="1"   placeholder="你QQ的第五位数" value="" type="number">
	        </div>
			<div data-role="controlgroup" >
	            <label for="my_qq3">
	                你QQ最后一位数：
	            </label>
	            <input name="my_qq3" id="my_qq3" maxlength="1"  size="1"   placeholder="你QQ最后一位数" value="" type="number">
	        </div>
