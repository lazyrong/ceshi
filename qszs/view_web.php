...
.main .cont{height:135px;width:440px;padding-left:320px;background:url(imgs/head2.jpg) no-repeat;overflow:hidden;padding-top:80px;}
.main .tip{height:40px;font-size:20px;color:red;font-family:"微软雅黑";overflow:hidden;}
.loading{display:none;position:absolute;width:200px;top:240px;color:#2b2b2b; padding:42px 72px;background:#FFFFFF;}
...
<div class="main">
	...
	<div class="m_bottom">
		<div class="bot1"><img src="imgs/head3.jpg" height="115" width="760" /></div>
	</div>
</div><!--/main-->
