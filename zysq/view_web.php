...
<style type="text/css">
.main{background:url(./imgs/bg.jpg) no-repeat center bottom;text-align:center;}
.main .t{height:190px;}
.main .tip{height:40px;font-size:20px;color:#333;font-family:"微软雅黑";}
.loading{display:none;position:absolute;width:200px;top:230px;color:#2b2b2b;padding:42px 72px;background:#FFFFFF;}
.load1{float:left;width:200px;height:12px;overflow:hidden;padding:1px;border:#8FCC52 1px solid;}
.load2{background:#8FCC52;height:100px;}
...
<body>
	...
	<div class="header">
		<div class="c">
			<div class="logo">
				...
				<img src="http://app.qpic.cn/mblogpic/3ad571c3942b830d9ee6/2000" height="30"></a>
			</div>
			<div class="l">
				<ul>
	...
	<div class="t"></div>
    <div class="b">
	<div class="tip" style="color:#000;">分析完成，查看结果</div>
