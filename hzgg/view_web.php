...
.main .cont{height:123px;width:460px;padding-left:300px;background:url(imgs/head5.jpg) no-repeat;overflow:hidden;padding-top:80px;}
...
<body>
	...
	<form method="post" action="view.php" name="pubForm">
	    <input type="hidden" name="name" value="内涵图" />
	    <a href="../result.php" ><img src="../file/imgs/view_result.gif" width="200" height="48"/></a>
    </div>
	<div class="m_bottom">
		<div class="bot1"><img src="imgs/head6.jpg" height="84" width="760" /></div>
	</div>
</div><!--/main-->
