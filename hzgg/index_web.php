...
<style type="text/css">
.main .head{height:193px;width:760px;overflow:hidden;}
.main .cont{height:203px;width:520px;padding-left:240px;background:url(imgs/head5.jpg) no-repeat;overflow:hidden;}
...
.main .m_bottom{height:84px;width:760px;overflow:hidden;}
</style>
<?php 
...
<div class="main">
	<div class="head">
		<div class="hd1"><img src="imgs/head1.jpg" width="760" height="52" /></div>
		<div class="hd2"><img src="imgs/head2.jpg" width="760" height="44" /></div>
		<div class="hd3"><img src="imgs/head3.jpg" width="760" height="44" /></div>
		<div class="hd4"><img src="imgs/head4.jpg" width="760" height="53" /></div>
	</div><!--/head-->
    <div class="cont">
		<ul>
		...
		<div class="btn"><a href="#" onclick="goUrl();"><img src="../file/imgs/mobile/bt1.gif" width="194" height="59" /></a></div>
	</div><!--/cont-->
	<div class="m_bottom">
		<div class="bot1"><img src="./imgs/head6.jpg" width="760" height="84" /></div>
	</div>
</div><!--/main-->
