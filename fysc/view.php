...
$content = '我刚在《疯狂方言测试》参加了四川方言八级水平考试并取得了' . $score . '的成绩，得到评价：' . $jieguo . ' 会讲英语算神马~会讲韩语是浮云~会讲日语鄙视你！有本事讲讲四川话！点击测试为普及四川话献出一份力量！ 测试地址：' . $url;
...
// @账号内容会过多
$pagrams [url] = $url;
$pagrams [title] = "点击测试->四川方言八级水平考试";
$pagrams [summary] = "四川方言八级水平考试，回答15道题，就能测出你的四川方言地道不地道~" . $pagrams [url];
