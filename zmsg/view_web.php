...
.main .cont{height:137px;width:460px;padding-left:300px;background:url(imgs/head3.jpg) no-repeat;overflow:hidden;padding-top:20px;}
...
.loading{display:none;position:absolute;width:240px;top:200px;color:#2b2b2b; padding:42px 72px;background:#FFFFFF;}
...
<div class="main">
	...
	<div class="mybtn"></div>
	<div class="m_bottom">
		<div class="bot1"><img src="imgs/head5.jpg" height="34" width="760" /></div>
	</div>
</div><!--/main-->
