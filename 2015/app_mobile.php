			...
			<div class="app_content">
				<form action="./" method="post" id="form1" name="form1">
					<div data-role="controlgroup" class="question" style="display:block;">  
						...
						<legend style="color:#27F;text-align:left;font-size:20px;">请选择你中意的数字：</legend>  
						<input type="radio" name="i1" id="i11" value="0" class="question_last_item">  
						<label for="i11">0</label>
						<input type="radio" name="i1" id="i12" value="1" class="question_last_item">  
						<label for="i12">1</label>
						<input type="radio" name="i1" id="i13" value="2" class="question_last_item">  
						<label for="i13">2</label>
						<input type="radio" name="i1" id="i14" value="3" class="question_last_item">  
						<label for="i14">3</label>
						<input type="radio" name="i1" id="i15" value="4" class="question_last_item">  
						<label for="i15">4</label>
						<input type="radio" name="i1" id="i16" value="5" class="question_last_item">  
						<label for="i16">5</label>
						<input type="radio" name="i1" id="i17" value="6" class="question_last_item">  
						<label for="i17">6</label>
						<input type="radio" name="i1" id="i18" value="7" class="question_last_item">  
						<label for="i18">7</label>
						<input type="radio" name="i1" id="i19" value="8" class="question_last_item">  
						<label for="i19">8</label>
						<input type="radio" name="i1" id="i110" value="9" class="question_last_item">  
						<label for="i110">9</label>
						</fieldset>  
					</div>		
