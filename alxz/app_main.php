...
.main_l .content .q_title{ margin-bottom:30px;color:#27F;font-size:20px;}
...
<div class="question" style="display:block">
    <p class="q_title">请选择你的星座类型：</p>
    <p class="last_item"><input type="radio" name="i1" value="1"/>白羊座</p>
	<p class="last_item"><input type="radio" name="i1" value="2"/>金牛座</p>
	<p class="last_item"><input type="radio" name="i1" value="3"/>双子座</p>
	<p class="last_item"><input type="radio" name="i1" value="4"/>巨蟹座</p>
	<p class="last_item"><input type="radio" name="i1" value="5"/>狮子座</p>
	<p class="last_item"><input type="radio" name="i1" value="6"/>处女座</p>
	<p class="last_item"><input type="radio" name="i1" value="7"/>天秤座</p>
	<p class="last_item"><input type="radio" name="i1" value="8"/>天蝎座</p>
	<p class="last_item"><input type="radio" name="i1" value="9"/>射手座</p>
	<p class="last_item"><input type="radio" name="i1" value="10"/>魔羯座</p>
	<p class="last_item"><input type="radio" name="i1" value="11"/>水瓶座</p>
	<p class="last_item"><input type="radio" name="i1" value="12"/>双鱼座</p>
    <?
if(islogined())
{
?>
<div class="clear"></div>
<div class="app_ad" id="mid_banner_ad" style="margin-left:-123px;margin-top:20px;">
