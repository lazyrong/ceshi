...
<style type="text/css">
.main .head{height:135px;width:760px;overflow:hidden;}
.main .cont{height:114px;width:490px;padding-left:270px;padding-top:5px;background:url(imgs/head3.jpg) no-repeat;overflow:hidden;}
.main .cont ul{float:left;width:360px;}
.main .mbtn{height:126px;width:425px;padding-left:335px;background:url(imgs/head4.jpg) no-repeat;overflow:hidden;}
.main .mbtn .btn{float:left;width:280px;padding-top:5px;}
...
.main .cont li span{height:38px;line-height:38px;font-weight:bold;margin-right:10px;color:#444641;float:left;}
.main .cont label{height:38px;line-height:38px;cursor:pointer;padding:0 30px 0 10px;font-weight:bold;color:#444641;}
.main .m_bottom{height:100px;width:760px;overflow:hidden;}
</style>
<?php 
...
<div class="main">
	<div class="head">
		<div class="hd1"><img src="imgs/head1.jpg" width="760" height="87" /></div>
		<div class="hd2"><img src="imgs/head2.jpg" width="760" height="48" /></div>
	</div><!--/head-->
    <div class="cont">
		<ul>
	...
	<div class="mbtn">
		<div class="btn"><a href="#" onclick="goUrl();"><img src="imgs/bt1.gif" height="55" width="191" /></a></div>
	</div>
	<div class="m_bottom">
		<div class="bot1"><img src="imgs/head5.jpg" width="760" height="51" /></div>
		<div class="bot2"><img src="imgs/head6.jpg" width="760" height="49" /></div>
	</div>
</div><!--/main-->
