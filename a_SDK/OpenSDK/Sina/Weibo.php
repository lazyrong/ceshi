...
require_once dirname(dirname(dirname(__FILE__))).'/OpenSDK/OAuth/Client.php';
require_once dirname(dirname(dirname(__FILE__))).'/OpenSDK/OAuth/Interface.php';
...
class OpenSDK_Sina_Weibo extends OpenSDK_OAuth_Interface
{
	...
	//设置oauth参数
	public static function setOauth($oauth_token,$oauth_token_secret)
	{
		self::setParam(self::ACCESS_TOKEN, $oauth_token);
		self::setParam(self::OAUTH_TOKEN_SECRET, $oauth_token_secret);
	}
