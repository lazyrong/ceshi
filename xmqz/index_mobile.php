...
<body>
<div class="face"><div class="a"><img src="/<?=$app_name?>/imgs/show.jpg" width="278" height="174"></div></div>
<div class="start"><a href="/<?=$app_name?>/test.php"><img src="../file/imgs/mobile/start.png" width="243" height="59" alt="开始测试" title="开始测试"></a></div>
<br/>
<?php 
