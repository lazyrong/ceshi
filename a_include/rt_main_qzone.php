...
.weibo_pic{ width:60px; height:60px; padding:1px; float:left; margin:30px 18px 0 188px; display:inline;}
...
.weibo_ri_text .weibo_ri_con{ font-size:18px; padding:3px 0;color: #646464;}
...
<div class="weibo_ri c_box " id="followQZone">
	<div class="weibo_ri_top">
    	<div class="weibo_pic"><a href="javascript:void(0)"></a></div>
 ...
 <div class="clear"></div>
     <div class="weibo_ri_fot">
      关注我们的QQ空间，然后 &nbsp;<span class="weibo_ri_fot_btn" id="viewResultBtn">&nbsp;</span>
    </div>
</div>
