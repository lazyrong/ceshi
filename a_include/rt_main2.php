...
.weibo_follow_pic{ width:114px; height:46px; padding:1px; border:1px solid #ccc; float:right; margin:0px 70px 0px 0px; display:inline;}
</style>
<script>
function checkFans()
{
...
<?php if ($rt_info['need_follow']['qzone_id']) {?>
	<div class="weibo_ri_top">
        ...
        <div class="weibo_ri_text">
        	...
        	<div class="weibo_ri_btn"><iframe src="http://open.qzone.qq.com/like?url=http%3A%2F%2Fuser.qzone.qq.com%2F<?=$rt_info['need_follow']['qzone_id']?>&type=button&width=400&height=30&style=3" allowtransparency="true" scrolling="no" border="0" frameborder="0" style="width:400px;height:30px;border:none;overflow:hidden;"></iframe></div>
