...
<link href="../file/css/show-min.css" rel="stylesheet" type="text/css" />
		...
		<script type="text/javascript">					
			...
			function sendRequest(isSendToMany, toId) {
		      var params = {"accept_url":"http://apps.renren.com/marrywho","accept_label":"去测试","app_msg":"想知道谁会和你结婚么？快来测测吧！"};
		      var style = null;
		      if (isSendToMany) {
		          params["actiontext"] = "上传成功！邀请好友一起来玩吧！";//邀请好友测试以后，你就可以等待他们上传答案了！";
				  style = {
					  "top":10 
				  };
		      }
			...
			function uploadToAlbum(){
				...
				document.getElementById("uploadToAlbum").innerHTML = '<table><tr><td><img id="waiting" style="margin-left:180px;" src="imgs/waiting.gif" /></td><td>正在加载</td></tr></table>';
				/*
				document.getElementById("uploadToAlbum1").onclick="";
				document.getElementById("uploadToAlbum1").style.width="50px";
				document.getElementById("uploadToAlbum1").style.margin-left="220px";
				*/			
				picUrl="createPic.php?score="+score+"&name="+name+"&rank="+rank+"&headurl="+headurl;
				//alert(picUrl);
				//alert(session_key);
				picUrl=encodeURIComponent(picUrl);
				//picUrl="http://marryrenren.chuchujie.com/home/page/"+picUrl;
				//alert(picUrl);
				//top.location.href=picUrl;
				
				var ajax=Ajax();
				ajax.post("uploadToAlbum.php",{session_key:session_key,picUrl:picUrl,uid:uid,rank:rank},function(b){
					//top.location.href='http://apps.renren.com/request.do?app_id=171886&send_button_label=确定&actiontext=邀请好友测试以后，你就可以等待他们上传答案了！&action=http://marryrenren.chuchujie.com/';
					sendRequest(true);
					document.getElementById("uploadToAlbum").innerHTML = "<div style='margin-left:180px'>上传成功，<a href=\"javascript:top.location.href='http://apps.renren.com/marrywho/'\">重新开始</a></div>";
				});
				
				//location.href="uploadToAlbum.php?session_key="+session_key+"&uid="+uid+"&picUrl="+picUrl;
	...
	<div class="c">
		...
		<div id="main-content">
		<div id="container">
			<img id="settingPic" style="display:none;" src="imgs/settingpic.gif" />
			<img id="reCheckSetting" style="display:none" src="imgs/huigu.png" onmouseover="huiguing()" onmouseout="huigued()" />
			<div id="setting">
				 <div id="start">
					<img id="start1" src="imgs/start.png" onclick="start11()" />
				</div>
			</div>
			<div id="questions" style="display:none;">
				<div id="question">
					<p id="title">你觉得B真是因为爱Y才和TA结婚的吗？</p>
				</div>
				
				<div id="answer">					 
					<div id="A" onclick="nextQuestion('A')">是</div>
					<div id="B" onclick="nextQuestion('B')">不是</div>					 
				</div>
			</div>
			<div id="result" style="display:none">
				<div id="score" >你的得分为：<span>50</span></div>
				<div id="rank" >48~60分。结婚对象：<span>你爱的人</span></div>
				<div id="comment">你是一个对爱情很有毅力的人，有一颗坚如磐石的心。只要认定一个人，便会付出一切努力去得到他。宁为玉碎不为瓦全，便是你的写照，你的坚韧能让对方感动而对你倾心，但同样过于执着，不择手段去得到他的人，只会让你的婚姻很不堪。幸福与彼此折磨的结局就在你的一念之间，始终坚持真诚与爱才能得到你想要得到的一切。婚姻不是爱的终点，你能得到的幸福应该更多。</div>
				<div id="uploadToAlbum">
					<img id="uploadToAlbum1" src="imgs/upload.gif" onclick="uploadToAlbum()"/>
				</div>
