...
.main .t{height:180px;background:url(./imgs/h1.jpg) no-repeat;}
.main .cs_form{height:290px;padding:10px 0 0 190px;background:url(./imgs/h2.jpg) no-repeat;text-align:center;}
.main .cs_form .uname{float:left;width:240px;height:28px;line-height:28px;padding:8px 0 10px 16px;font-size:16px;background:url(../file/imgs/input2.gif) no-repeat;border:none;color:#333;}
.main .cs_form .submit{float:left;width:115px;height:46px;background:url(../file/imgs/start2.gif) no-repeat;border:none;cursor:pointer;}
</style>
<?php 
