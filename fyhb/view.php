...
if ($score > 20 && $score <= 40) {
	$jieguo = "你的湖北话貌似还欠点火候，再学习学习吧～";
}

if ($score > 40 && $score <= 60) {
	$jieguo = "到湖北有几年了吧～有些湖北味喽～哈哈哈～";
}

if ($score > 60 && $score <= 80) {
	$jieguo = "你的湖北话很不错，可以自由行走湖北了～～";
}
if ($score > 80) {
	$jieguo = "你是湖北本地人吧～！完全难不倒你啊～膜拜下～";
}
...
$content = '我刚在《疯狂方言测试》参加了湖北方言八级水平考试并取得了' . $score . '的成绩，得到评价：' . $jieguo . ' 会讲英语算神马~会讲韩语是浮云~会讲日语鄙视你！有本事讲讲湖北话！点击测试为普及湖北话献出一份力量！ 测试地址：' . $url;
...
// @账号内容会过多
$pagrams [url] = $url;
$pagrams [title] = "点击测试->湖北方言八级水平考试";
$pagrams [summary] = "湖北方言八级水平考试，回答20道题，就能测出你的湖北方言地道不地道~" . $pagrams [url];
