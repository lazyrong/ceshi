	...
	<div class="center">
		...
		<div class="cont" id="box1">
			...
			<div class="tt">共20题</div>
				...
				<dt id="t1">1、他的身高是多少？</dt>
                				<dd>
                	<input type="radio" id="list10" name="a1" value="-20" onclick="check(1,1)"  />
					<label for="list10" onmouseover="this.className='red'" onmouseout="this.className=''">A、低于160cm</label>
                </dd>
                				<dd>
                	<input type="radio" id="list11" name="a1" value="-10" onclick="check(1,1)"  />
					<label for="list11" onmouseover="this.className='red'" onmouseout="this.className=''">B、160-170cm</label>
                </dd>
                				<dd>
                	<input type="radio" id="list12" name="a1" value="0" onclick="check(1,1)"  />
					<label for="list12" onmouseover="this.className='red'" onmouseout="this.className=''">C、170-180cm</label>
                </dd>
                				<dd>
                	<input type="radio" id="list13" name="a1" value="10" onclick="check(1,1)"  />
					<label for="list13" onmouseover="this.className='red'" onmouseout="this.className=''">D、180-190cm</label>
                </dd>
                				<dd>
                	<input type="radio" id="list14" name="a1" value="20" onclick="check(1,1)"  />
					<label for="list14" onmouseover="this.className='red'" onmouseout="this.className=''">E、超过190cm</label>
                </dd>
                			</dl>
            			<dl id="tm2" onmouseover="change1(2);" onmouseout="change2(2);">
				<dt id="t2">2、他的年龄？</dt>
                				<dd>
                	<input type="radio" id="list20" name="a2" value="0" onclick="check(1,2)"  />
					<label for="list20" onmouseover="this.className='red'" onmouseout="this.className=''">A、小于20岁</label>
                </dd>
                				<dd>
                	<input type="radio" id="list21" name="a2" value="10" onclick="check(1,2)"  />
					<label for="list21" onmouseover="this.className='red'" onmouseout="this.className=''">B、20-25岁</label>
                </dd>
                				<dd>
                	<input type="radio" id="list22" name="a2" value="0" onclick="check(1,2)"  />
					<label for="list22" onmouseover="this.className='red'" onmouseout="this.className=''">C、26-30岁</label>
                </dd>
                				<dd>
                	<input type="radio" id="list23" name="a2" value="-10" onclick="check(1,2)"  />
					<label for="list23" onmouseover="this.className='red'" onmouseout="this.className=''">D、大于30岁</label>
                </dd>
                			</dl>
            			<dl id="tm3" onmouseover="change1(3);" onmouseout="change2(3);">
				<dt id="t3">3、是否会打篮球？</dt>
                				<dd>
                	<input type="radio" id="list30" name="a3" value="10" onclick="check(1,3)"  />
					<label for="list30" onmouseover="this.className='red'" onmouseout="this.className=''">A、会打</label>
                </dd>
                				<dd>
                	<input type="radio" id="list31" name="a3" value="0" onclick="check(1,3)"  />
					<label for="list31" onmouseover="this.className='red'" onmouseout="this.className=''">B、不会打</label>
                </dd>
                			</dl>
            			<dl id="tm4" onmouseover="change1(4);" onmouseout="change2(4);">
				<dt id="t4">4、是否会游泳？</dt>
                				<dd>
                	<input type="radio" id="list40" name="a4" value="10" onclick="check(1,4)"  />
					<label for="list40" onmouseover="this.className='red'" onmouseout="this.className=''">A、会</label>
                </dd>
                				<dd>
                	<input type="radio" id="list41" name="a4" value="0" onclick="check(1,4)"  />
					<label for="list41" onmouseover="this.className='red'" onmouseout="this.className=''">B、不会</label>
                </dd>
                			</dl>
            			<dl id="tm5" onmouseover="change1(5);" onmouseout="change2(5);">
				<dt id="t5">5、是否会斗地主？</dt>
                				<dd>
                	<input type="radio" id="list50" name="a5" value="10" onclick="check(1,5)"  />
					<label for="list50" onmouseover="this.className='red'" onmouseout="this.className=''">A、会</label>
                </dd>
                				<dd>
                	<input type="radio" id="list51" name="a5" value="0" onclick="check(1,5)"  />
					<label for="list51" onmouseover="this.className='red'" onmouseout="this.className=''">B、不会</label>
                </dd>
                			</dl>
				...
				<dt id="t6">6、他的体重？</dt>
					...
					<label for="list60" onmouseover="this.className='red'" onmouseout="this.className=''">A、不足50公斤</label>
                </dd>
                				<dd>
                	<input type="radio" id="list61" name="a6" value="-10" onclick="check(1,6)"  />
					<label for="list61" onmouseover="this.className='red'" onmouseout="this.className=''">B、50-60公斤</label>
                </dd>
                				<dd>
                	<input type="radio" id="list62" name="a6" value="10" onclick="check(1,6)"  />
					<label for="list62" onmouseover="this.className='red'" onmouseout="this.className=''">C、60-75公斤</label>
                </dd>
                				<dd>
                	<input type="radio" id="list63" name="a6" value="-10" onclick="check(1,6)"  />
					<label for="list63" onmouseover="this.className='red'" onmouseout="this.className=''">D、75-85公斤</label>
                </dd>
                				<dd>
                	<input type="radio" id="list64" name="a6" value="-20" onclick="check(1,6)"  />
					<label for="list64" onmouseover="this.className='red'" onmouseout="this.className=''">E、超过85公斤</label>
                </dd>
                			</dl>
            			<dl id="tm7" onmouseover="change1(7);" onmouseout="change2(7);">
				<dt id="t7">7、他的近视程度？</dt>
                				<dd>
				...
				<dt id="t8">8、是否谈过恋爱？</dt>
                				<dd>
                	<input type="radio" id="list80" name="a8" value="10" onclick="check(1,8)"  />
				...
				<dt id="t9">9、他更重视朋友还是更重视你？</dt>
                				<dd>
                	<input type="radio" id="list90" name="a9" value="10" onclick="check(1,9)"  />
					<label for="list90" onmouseover="this.className='red'" onmouseout="this.className=''">A、朋友更重要</label>
                </dd>
                				<dd>
                	<input type="radio" id="list91" name="a9" value="0" onclick="check(1,9)"  />
					<label for="list91" onmouseover="this.className='red'" onmouseout="this.className=''">B、女人更重要</label>
                </dd>
                			</dl>
            			<dl id="tm10" onmouseover="change1(10);" onmouseout="change2(10);">
				<dt id="t10">10、他什么地方最吸引人？</dt>
                				<dd>
                	<input type="radio" id="list100" name="a10" value="-10" onclick="check(1,10)"  />
					<label for="list100" onmouseover="this.className='red'" onmouseout="this.className=''">A、脸蛋</label>
                </dd>
                				<dd>
                	<input type="radio" id="list101" name="a10" value="10" onclick="check(1,10)"  />
					<label for="list101" onmouseover="this.className='red'" onmouseout="this.className=''">B、身材</label>
                </dd>
                				<dd>
                	<input type="radio" id="list102" name="a10" value="20" onclick="check(1,10)"  />
					<label for="list102" onmouseover="this.className='red'" onmouseout="this.className=''">C、气质</label>
                </dd>
                				<dd>
                	<input type="radio" id="list103" name="a10" value="0" onclick="check(1,10)"  />
					<label for="list103" onmouseover="this.className='red'" onmouseout="this.className=''">D、其它</label>
                </dd>
                			</dl>
            		</div>
        ...
        <div class="cont" id="box2" style="display:none;">
			...
			<div class="tt">共20题</div>
				...
				<dt id="t11">11、是否会开车？</dt>
					...
					<label for="list110" onmouseover="this.className='red'" onmouseout="this.className=''">A、会</label>
                </dd>
                				<dd>
                	<input type="radio" id="list111" name="a11" value="0" onclick="check(2,11)"  />
					<label for="list111" onmouseover="this.className='red'" onmouseout="this.className=''">B、不会</label>
                </dd>
                			</dl>
            			<dl id="tm12" onmouseover="change1(12);" onmouseout="change2(12);">
				<dt id="t12">12、他的英语水平？</dt>
                				<dd>
					...
					<label for="list120" onmouseover="this.className='red'" onmouseout="this.className=''">A、没过四级</label>
                				...
                				<dd>
                	<input type="radio" id="list121" name="a12" value="0" onclick="check(2,12)"  />
				...
				<dt id="t13">13、他的歌声</dt>
                				<dd>
                	<input type="radio" id="list130" name="a13" value="-20" onclick="check(2,13)"  />
					...
					<label for="list131" onmouseover="this.className='red'" onmouseout="this.className=''">B、唱得不错</label>
                				...
                				<dd>
                	<input type="radio" id="list132" name="a13" value="20" onclick="check(2,13)"  />
				...
				<dt id="t14">14、是否会溜冰？</dt>
                				<dd>
                	<input type="radio" id="list140" name="a14" value="0" onclick="check(2,14)"  />
					<label for="list140" onmouseover="this.className='red'" onmouseout="this.className=''">A、会</label>
                </dd>
                				<dd>
                	<input type="radio" id="list141" name="a14" value="-20" onclick="check(2,14)"  />
					<label for="list141" onmouseover="this.className='red'" onmouseout="this.className=''">B、不会</label>
                </dd>
                			</dl>
            			<dl id="tm15" onmouseover="change1(15);" onmouseout="change2(15);">
				<dt id="t15">15、是否会打麻将？</dt>
                				<dd>
                	<input type="radio" id="list150" name="a15" value="0" onclick="check(2,15)"  />
					<label for="list150" onmouseover="this.className='red'" onmouseout="this.className=''">A、会</label>
                </dd>
                				<dd>
                	<input type="radio" id="list151" name="a15" value="10" onclick="check(2,15)"  />
				...
				<dt id="t16">16、是否会喝酒？</dt>
					...
					<label for="list160" onmouseover="this.className='red'" onmouseout="this.className=''">A、不会喝酒</label>
                				...
                				<dd>
                	<input type="radio" id="list161" name="a16" value="10" onclick="check(2,16)"  />
				...
				<dt id="t17">17、是否会做饭？</dt>
                				<dd>
                	<input type="radio" id="list170" name="a17" value="10" onclick="check(2,17)"  />
					<label for="list170" onmouseover="this.className='red'" onmouseout="this.className=''">A、会</label>
                </dd>
                				<dd>
                	<input type="radio" id="list171" name="a17" value="0" onclick="check(2,17)"  />
					<label for="list171" onmouseover="this.className='red'" onmouseout="this.className=''">B、不会</label>
                </dd>
                			</dl>
            			<dl id="tm18" onmouseover="change1(18);" onmouseout="change2(18);">
				<dt id="t18">18、是否喜欢养宠物？</dt>
                				<dd>
                	<input type="radio" id="list180" name="a18" value="10" onclick="check(2,18)"  />
					<label for="list180" onmouseover="this.className='red'" onmouseout="this.className=''">A、喜欢</label>
                </dd>
                				<dd>
                	<input type="radio" id="list181" name="a18" value="0" onclick="check(2,18)"  />
					<label for="list181" onmouseover="this.className='red'" onmouseout="this.className=''">B、不喜欢</label>
                </dd>
                			</dl>
            			<dl id="tm19" onmouseover="change1(19);" onmouseout="change2(19);">
				<dt id="t19">19、是否喜欢玩游戏？</dt>
                				<dd>
                	<input type="radio" id="list190" name="a19" value="0" onclick="check(2,19)"  />
					<label for="list190" onmouseover="this.className='red'" onmouseout="this.className=''">A、喜欢</label>
                </dd>
                				<dd>
                	<input type="radio" id="list191" name="a19" value="10" onclick="check(2,19)"  />
					<label for="list191" onmouseover="this.className='red'" onmouseout="this.className=''">B、不喜欢</label>
                </dd>
                			</dl>
            			<dl id="tm20" onmouseover="change1(20);" onmouseout="change2(20);">
				<dt id="t20">20、是否喜欢吃大蒜？</dt>
                				<dd>
                	<input type="radio" id="list200" name="a20" value="-10" onclick="check(2,20)"  />
					<label for="list200" onmouseover="this.className='red'" onmouseout="this.className=''">A、喜欢</label>
                </dd>
                				<dd>
                	<input type="radio" id="list201" name="a20" value="0" onclick="check(2,20)"  />
					<label for="list201" onmouseover="this.className='red'" onmouseout="this.className=''">B、不喜欢</label>
                </dd>
                			</dl>
            		</div>
		<s class="b"></s>
